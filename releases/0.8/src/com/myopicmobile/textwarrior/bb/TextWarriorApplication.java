...
implements TextWarriorStringsResource{
	...
	public TextWarriorApplication() { 
		...
		addGlobalEventListener(c);
        checkPermissions();
        _originalLocale = Locale.getDefaultInputForSystem();
    ...
    public void activate(){
    	// restore locale selected by user just for the app
    	restoreContext();
    }
    
    public void deactivate(){
    	// restore original locale before app was started
    	restoreContext();
    }
    
    public void restoreContext(){
    	Locale temp =  Locale.getDefaultInputForSystem();
    	Locale.setDefaultInputForSystem(_originalLocale);
    	_originalLocale = temp;
    }
}
