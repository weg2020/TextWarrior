...
public class TokenScanner implements Runnable {
	private static CharacterEncodings _language = null;
	...
	public static void setLanguage(CharacterEncodings c){
		_language = c;
	}
	 ...
	 */
	public static Vector tokenize(DocumentProvider hDoc, int maxChars){
